...
function sharedPkgFiles(): Record<string, string | null> {
  return {
...
describe("WorkspaceScanner API", () => {
  describe("pnpm workspace", () => {
    ...
    it("detects correct workspace type", () => {
    ...
    it("builds correct dependent graph", () => {
  ...
  describe("transitive dependency queries", () => {
    let rootDir: string;
